 ...
 */
class getUserAdminRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserAdminRepository' shared autowired service.
     *
     * @return \App\Repository\UserAdminRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/UserAdminRepository.php';

        return $container->privates['App\\Repository\\UserAdminRepository'] = new \App\Repository\UserAdminRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
